...
class HyperFuturisticHomeScreen extends StatefulWidget {
  ...
  const HyperFuturisticHomeScreen({super.key, required this.prefs, required this.userName, required this.country, required this.currency, required this.themeIndex, required this.onThemeChanged});
  @override State<HyperFuturisticHomeScreen> createState()=>_HyperFuturisticHomeScreenState();
}

class _HyperFuturisticHomeScreenState extends State<HyperFuturisticHomeScreen> with TickerProviderStateMixin {
  late final AnimationController _pulse=AnimationController(vsync:this,duration:const Duration(seconds:4))..repeat();
  late final AnimationController _orbit=AnimationController(vsync:this,duration:const Duration(seconds:18))..repeat();
