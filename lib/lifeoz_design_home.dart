...
class _LifeOZDesignHomeState extends State<LifeOZDesignHome> {
  ...
  void _openCore(int index) {
    const messages = [
      'Growth intelligence is ready.', 'Care and household intelligence is ready.',
      'Prosperity intelligence is ready.', 'Time and commitment intelligence is ready.',
      'Personal intelligence is ready.'
    ];
    _say(messages[index]);
    Navigator.push(context, MaterialPageRoute(builder: (_) => LifeOZCoreHub(prefs: widget.prefs, coreIndex: index)));
  }
  ...
  @override Widget build(BuildContext context) {
    return Scaffold(backgroundColor: const Color(0xFF01030A), body: SafeArea(child: Stack(children: [
      ...
      Positioned(left: 24, right: 24, top: 160, bottom: 100, child: Column(children: [
        GestureDetector(onTap: () => _say('I am Yansi, your silent LifeOS intelligence.'), child: Expanded(child: Image.asset('03_Yansi_Silent_Intelligence.png', fit: BoxFit.contain))),
        const SizedBox(height: 8),
        Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          _CoreButton(color: const Color(0xFF4FEF83), glyph: Icons.eco_outlined, onTap: () => _openCore(0)),
          _CoreButton(color: const Color(0xFFFFB83D), glyph: Icons.auto_graph_rounded, onTap: () => _openCore(1)),
          _CoreButton(color: const Color(0xFF42D9FF), glyph: Icons.schedule_rounded, onTap: () => _openCore(2)),
          _CoreButton(color: const Color(0xFFC86BFF), glyph: Icons.track_changes_rounded, onTap: () => _openCore(3)),
          _CoreButton(color: const Color(0xFFFF5A61), glyph: Icons.favorite_outline_rounded, onTap: () => _openCore(4)),
        ]),
      ])),
...
class _CoreButton extends StatelessWidget {
  final Color color; final IconData glyph; final VoidCallback onTap;
  const _CoreButton({required this.color, required this.glyph, required this.onTap});
