...
/// Corrected router implementation; the canonical router is replaced in the
/// next tree commit after CI's analyzer failures are addressed.
class YansiResponseRouterV2 {
  final LifeOSSignalStore store;
  final YansiVoiceIntentParser parser;
  const YansiResponseRouterV2(this.store, {this.parser = const YansiVoiceIntentParser()});
