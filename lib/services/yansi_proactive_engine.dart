...
/// Predictions are explainable; sensitive actions still require confirmation.
...
class YansiProactiveEngine {
  ...
  Future<YansiProactiveInsight?> scan() async {
    ...
    final best=candidates.first;await prefs.setString('yansi_last_prediction',jsonEncode({'title':best.title,'core':best.core,'confidence':best.confidence,'at':now.toIso8601String(),'data':best.data}));return best;
  }
}
