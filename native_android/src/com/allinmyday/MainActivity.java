...
public final class MainActivity extends Activity {
    ...
    final class AllinmydayView extends View {
        ...
        @Override protected void onDraw(Canvas c) {
            ...
            // Yansi is intentionally NOT rendered here. Ghost mode means the intelligence
            // remains ambient/background and appears only through permitted voice/status feedback.
            for(int i=0;i<cores.length;i++) {
                Point q=project(cores[i][0],cores[i][1],cores[i][2],cx,cy,w,h);
        ...
        private void openCore(int index) {
            ...
            amount.setHint("Amount (optional)");
